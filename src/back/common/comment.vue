            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th><span class="glyphicon glyphicon-file"></span> <span class="">摘要</span></th>
                        <th><span class="glyphicon glyphicon-time"></span> <span class="">评论时间</span></th>
                ...
                <tbody>
                    <tr v-for="(item, index) in dataList" :key="index">
                        ...
                        <td> <router-link :to="{name:'updateNotice', query:{_id:item._id}}">查看</router-link> <a @click="deleteNotice(item._id)">删除</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            deleteNotice(id){
                this.$ajax.get('/control/deleteNotice?_id='+id)
                .then(res => {
                    //删除成功后重新刷新页面加载数据
                    this.reload();
