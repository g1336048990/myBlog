			...
			<div class="col-md-3">
				...
				<div class="add-article-box">
					...
					<div class="add-article-box-content">
						<p>
							<label>状态：</label>
							<span class="article-status-display">{{ dataList.releaseStatus }}</span>
						</p>
						<p>
							<label>公开度：</label>
					...
					<div class="add-article-box-footer"><button class="btn btn-primary" @click="submitData()" name="submit">发布</button></div>
				</div>
			</div>
		</div>
	</div>
