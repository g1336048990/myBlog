          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-user"></span> <span class="visible-lg">用户ID</span></th>
                <th><span class="glyphicon glyphicon-bookmark"></span> <span class="visible-lg">用户名</span></th>
                <th><span class="glyphicon glyphicon-phone-alt"></span> <span class="visible-lg">电话</span></th>
								<th><span class="glyphicon glyphicon-asterisk"></span> <span class="visible-lg">密码</span></th>
...
<script>
  ...
  export default {
    ...
    created(){
		...
		methods: {
			userInfo() {
				this.$ajax.get('/control_userInfo?indexPage='+this.indexPage)
					.then(res => {
			...
			submitEdit() {
				...
				this.$ajax.post('/control_editUser', this.onedate)
				.then(res => {
					this.$router.go(0);
				})
				.catch(err => {
			...
			deleteUser(_id) {
				this.$ajax.get('/control_deleteUser?_id='+_id)
				.then(res => {
					this.reload();
				})
				.catch(err => {
