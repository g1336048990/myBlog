		    ...
		    <div class="content">
		      ...
		      <div id="focusslide" class="carousel slide" data-ride="carousel">
		        ...
		        <div class="carousel-inner" role="listbox">
		          <div class="item active"> <a href="" target="_blank"><img src="../../static/images/banner/banner_01.jpg" alt="" class="img-responsive"></a> 
		            <!--<div class="carousel-caption"> </div>--> 
		          </div>
		          <div class="item"> <a href="" target="_blank"><img src="../../static/images/banner/banner_02.jpg" alt="" class="img-responsive"></a> 
		            <!--<div class="carousel-caption"> </div>--> 
		          </div>
		          <div class="item"> <a href="" target="_blank"><img src="../../static/images/banner/banner_03.jpg" alt="" class="img-responsive"></a> 
		            <!--<div class="carousel-caption"> </div>--> 
		          </div>
		        </div>
		          ...
		          <div role="tabpanel" class="tab-pane notice active" id="notice">
		            <ul>
		              <li>
		                ...
		                <a href="" target="_blank">欢迎访问郭羽的博客</a></li>
		              <li>
		                <time datetime="2016-01-04">01-04</time>
